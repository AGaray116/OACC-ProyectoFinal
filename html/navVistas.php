            ...
            ?>
                ...
                <ul class="dropdown-menu">
                    ...
                    ?>
                        ...
                        <div>
                            <a class="dropdown-item" href="calendario.php">Visualizar Calendario</a>
                        </div>
                        <div>
                            <a class="dropdown-item" href="citasDoctor.php">Ver citas</a>
                        </div>
                        <div>
                    ...
                    ?>
                        ...
                        <div><a class="dropdown-item" href="resgistroPas_Ses.php">Registrar Pacientes</a></div>
                        <div><a class="dropdown-item" href="agendarCita.php">Agendar Citas</a></div>
                        <div><a class="dropdown-item" href="calendario.php">Administrar Calendario</a></div>
                    ...
                    ?>
                        ...
                        <div><a class="dropdown-item" href="citasPaciente.php">Citas Agendadas</a></div>
                        <div><a class="dropdown-item" href="../PHP/cerrar_sesion.php">Cerrar Sesión</a></div>
                    <?php
                    }
                } else {
